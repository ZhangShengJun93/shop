...
<title>小卖部管理平台</title> <#include "../common/header.ftl"/>
...
<script type="text/javascript">
	...
	function selectSkuProperty(skuPropertyId){
		$.ajax({ 
			url: "/productSku/skuPropertyValue/"+skuPropertyId,
			dataType:"html",
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<!-- 提交商品SKU表单 -->
				<form action="/productSku/save" method="post" id="productSkuSaveForm">
