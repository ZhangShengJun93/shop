                            ...
                            <div role="tabpanel" class="tab-pane" id="detail">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                        <textarea id="desc"
                                                  name="productDesc.details"
                                                  class="ckeditor"
                                                  rows="10">${(productDesc.details)!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div style="padding-bottom: 10px; padding-left: 10px; padding-right: 10px; padding-top: 10px;">
                                    ...
                                    <#list productImages as productImage>
                                        <div class="col-lg-3 col-md-6">
                                            <input type="hidden"
                                                   class="imgInput"
                                                   name="productImages[${productImage_index}].id"
                                                   value="${(productImage.id)!}">
                                            <div class="image-div">
                                                <div>
                                                    <a href="javascript:;"
                                                       id="uploadImage-btn${productImage_index}"
                                                       class="js-upload">上传</a>
                                                </div>
                                                <img id="img${productImage_index}" class="uploadImg" src="${(productImage.imagePath)!}">

                                                <#--<input type="hidden" name="productImages[${productImage_index}].id" value="${productImage.id}">-->
                                                <input type="hidden"
                                                       class="imgInput"
                                                       name="productImages[${productImage_index}].imagePath"
                                                       value="${(productImage.imagePath)!}">
                                            </div>
                                            <div class="input-group">
                                                <select class="form-control sequence"
                                                        name="productImages[${productImage_index}].sequence">
                                                    <option value="1"
                                                            <#if productImage.sequence==1>selected</#if>>1
                                                    </option>
                                                    <option value="2"
                                                            <#if productImage.sequence==2>selected</#if>>2
                                                    </option>
                                                    <option value="3"
                                                            <#if productImage.sequence==3>selected</#if>>3
                                                    </option>
                                                    <option value="4"
                                                            <#if productImage.sequence==4>selected</#if>>4
                                                    </option>
                                                    <option value="5"
                                                            <#if productImage.sequence==5>selected</#if>>5
                                                    </option>
                                                    <option value="6"
                                                            <#if productImage.sequence==6>selected</#if>>6
                                                    </option>
                                                    <option value="7"
                                                            <#if productImage.sequence==7>selected</#if>>7
                                                    </option>
                                                    <option value="8"
                                                            <#if productImage.sequence==8>selected</#if>>8
                                                    </option>
                                                </select>
                                                <span class="input-group-addon">
                                                    <label>
                                                        <input type="radio"
                                                               class="productImageCover cover"
                                                               name="productImages[${productImage_index}].cover"
                                                               value="0">
                                                        <span>封面</span>
                                                    </label>
                                                </span>
