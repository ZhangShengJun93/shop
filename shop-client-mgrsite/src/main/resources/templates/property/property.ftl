...
<#include "../common/header.ftl"/>
    ...
    <script type="text/javascript">
        ...
        function ValueForm() {
            //使用ajaxSubmit提交表单
            $("#catalogPropertyValueForm").ajaxSubmit({
                dataType: 'json',
                success: function (data) {
                    if (data.success) {
        ...
        function saveCatalogProperty() {
            ...
            form.ajaxSubmit(function (data) {
                if (data.success) {
                    $.messager.confirm("提示", "保存成功!", function () {
                        $("#catalogPropertyPanel").load("/catalogProperty/get/" + data.result);
                    });
                } else {
                    $.messager.alert("提示", data.message);
                }
        ...
        function deleteCatalogProperty(id, catalogId) {
            $.messager.confirm("提示", "确定删除吗？", function () {
                $.get("/catalogProperty/delete?id=" + id + "&catalogId=" + catalogId,
                        function (data) {
                            if (data.success) {
                                $.messager.confirm("提示", "删除成功!", function () {
                                    $("#catalogPropertyPanel").load("/catalogProperty/get/" + data.result);
