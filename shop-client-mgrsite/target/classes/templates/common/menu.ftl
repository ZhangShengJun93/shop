<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="product_list">
			...
			<li class="product_brand"><a href="/brand_list">商品品牌</a></li>
	...
	<li class="list-group-item">
		...
		<ul class="in" id="product_list">
			<li class="product_brand"><a href="/orderInfo">订单列表</a></li>
			<li class="add_product"><a href="/orderInfoSend">发货订单列表</a></li>
			<li class="product_list"><a href="/orderReturn">退货单列表</a></li>
		</ul>
	</li>
	<li class="list-group-item">
